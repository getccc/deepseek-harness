...
**The face in the sidebar brand slot or the application icon.** Rejected while those places carried the company mark, by which a member found the window and the tray: the assistant's face belonged where the assistant speaks. [The WeWork logo is 小微's figure](../architecture/2026-09-11-the-wework-logo-is-xiaoweis-figure.md) reverses this for every brand place the source tree owns.
