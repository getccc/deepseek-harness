...
| [knowledge.md](knowledge.zh.md) | 私有知识 seam：`KnowledgeRef`、已授权目录、段落检索、`knowledge/scope` 会话值、`KnowledgeFailureReason` |
| [bi.md](bi.zh.md) | BI 分析 seam：`BiProjectRef`/`BiChartRef`、已授权项目目录、已保存图表的列表与执行、`bi/scope` 会话值、`BiFailureReason` |
