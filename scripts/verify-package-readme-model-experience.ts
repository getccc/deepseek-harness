...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bi/bi-source': { kind: 'none', reason: 'Control Plane seam; the Control Plane mounts no agent or tool registry, so a model never reaches it.' },
  ...
  'packages/api/bi-controller': { kind: 'indirect', reason: 'The Remote records the project choice the browser makes; dsh-tool-bi is what names it to the model.' },
  ...
  'packages/client/ui-bi': { kind: 'indirect', reason: 'Browser-side composer control; the project it records is what dsh-tool-bi names in the prompt and gates the tools on.' },
  ...
  'packages/client/ui-sidebar-documentpreview-office': { kind: 'none', reason: 'Browser-only office document renderers; registers no tool, prompt section, or session event.' },
  ...
  'packages/account/account-auth': { kind: 'none', reason: 'Server-side authentication: the seam registers no prompt section, tool, or request context.' },
  'packages/account/account-auth-password': { kind: 'none', reason: 'Server-side password verification: the provider registers no prompt section, tool, or request context.' },
  'packages/access/access-control': { kind: 'none', reason: 'Server-side authorization: the seam registers no prompt section, tool, or request context.' },
  ...
  'packages/access/quota': { kind: 'none', reason: 'Server-side budget ledger: the seam registers no prompt section, tool, or request context.' },
  'packages/access/quota-sqlite': { kind: 'none', reason: 'Server-side budget storage: the backend registers no prompt section, tool, or request context.' },
  'packages/llm/model-gateway': { kind: 'none', reason: 'Server-side model catalog and decision: the seam registers no prompt section, tool, or request context.' },
  'packages/llm/model-gateway-sqlite': { kind: 'none', reason: 'Server-side model-catalog storage: the backend registers no prompt section, tool, or request context.' },
  'packages/llm/model-gateway-http': { kind: 'none', reason: 'Server-side model endpoint: the plugin registers no prompt section, tool, or request context.' },
  'packages/llm/llm-http-transport': { kind: 'none', reason: 'Transport seam: it declares how a request travels and registers no prompt section, tool, or request context.' },
  'packages/llm/llm-http-transport-team': { kind: 'none', reason: 'Company transport: it carries a request an adapter built and registers no prompt section, tool, or request context.' },
  ...
  'packages/team/team-console-menu-sqlite': { kind: 'none', reason: 'Durable administration navigation: the plugin registers no prompt section, tool, or request context.' },
  'packages/team/team-admin-app': { kind: 'none', reason: 'Static files for the administration console: the plugin registers no prompt section, tool, or request context.' },
  'packages/team/team-browser-session': { kind: 'none', reason: 'Browser authentication helpers: the package registers no prompt section, tool, or request context.' },
  ...
  'packages/team/team-update': { kind: 'none', reason: 'Installation decisions: the package registers no prompt section, tool, or request context.' },
