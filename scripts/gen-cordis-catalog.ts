...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  consoleMenu: 'access-control.md',
  audit: 'audit.md',
  quota: 'quota.md',
  modelGateway: 'model-gateway.md',
  llmHttpTransport: 'model-gateway.md',
  deviceAuthorization: 'device-authorization.md',
  teamAccountClient: 'team-handoff.md',
  ...
  knowledgeGateway: 'knowledge.md',
  knowledgeSource: 'knowledge.md',
  web: 'web.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  browserSession: 'interface-typed (BrowserSession); the implementing BrowserAuth is private to the package — packages/client/connection/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PeriodKey: 'quota.md',
  QuotaUsage: 'quota.md',
  Reservation: 'quota.md',
  ReservationId: 'quota.md',
  ReservationRequest: 'quota.md',
  Settlement: 'quota.md',
  ...
  RegisterModel: 'model-gateway.md',
  TransportOperation: 'model-gateway.md',
  TransportModel: 'model-gateway.md',
  TransportRequest: 'model-gateway.md',
  TransportResponse: 'model-gateway.md',
  AccessTokenClaims: 'device-authorization.md',
  Approval: 'device-authorization.md',
  Device: 'device-authorization.md',
  DeviceId: 'device-authorization.md',
  FamilyId: 'device-authorization.md',
  IssuedCode: 'device-authorization.md',
  IssuedCredential: 'device-authorization.md',
  PendingTransaction: 'device-authorization.md',
  RedeemRequest: 'device-authorization.md',
  RefreshRequest: 'device-authorization.md',
  StartRequest: 'device-authorization.md',
  StartedTransaction: 'device-authorization.md',
  TransactionId: 'device-authorization.md',
  ...
  SecretPolicy: 'account.md',
  AccountUserStatus: 'account.md',
  BrowserSessionRecord: 'account.md',
  CreateAccountUser: 'account.md',
  CreateDepartment: 'account.md',
  Department: 'account.md',
  DeptId: 'account.md',
  Organization: 'account.md',
  OrgId: 'account.md',
  UpdateOrganization: 'account.md',
  UpdateAccountUser: 'account.md',
  UpdateDepartment: 'account.md',
  UserId: 'account.md',
  ConsoleMenu: 'access-control.md',
  CreateConsoleMenu: 'access-control.md',
  MenuId: 'access-control.md',
  UpdateConsoleMenu: 'access-control.md',
  ...
  GovernedDocumentRequest: 'knowledge.md',
  GovernedDocumentsRequest: 'knowledge.md',
  GovernedSearchRequest: 'knowledge.md',
  BiCatalogView: 'bi.md',
  BiChartRef: 'bi.md',
  BiProjectRef: 'bi.md',
  BiChartPage: 'bi.md',
  BiChartsRequest: 'bi.md',
  BiPrincipal: 'bi.md',
  BiProjectEntry: 'bi.md',
  BiQueryRequest: 'bi.md',
  BiQueryResult: 'bi.md',
  GovernedChartsRequest: 'bi.md',
  GovernedQueryRequest: 'bi.md',
  UpstreamChartListing: 'bi.md',
  UpstreamChartPlacement: 'bi.md',
  UpstreamChartsRequest: 'bi.md',
  UpstreamProject: 'bi.md',
  UpstreamRun: 'bi.md',
  UpstreamRunRequest: 'bi.md',
  KnowledgeBaseEntry: 'knowledge.md',
  KnowledgeRef: 'knowledge.md',
  KnowledgeCatalogView: 'knowledge.md',
  KnowledgeDocumentContent: 'knowledge.md',
  KnowledgeDocumentPage: 'knowledge.md',
  KnowledgeDocumentRequest: 'knowledge.md',
  KnowledgeDocumentsRequest: 'knowledge.md',
  KnowledgePrincipal: 'knowledge.md',
  UpstreamDocumentContent: 'knowledge.md',
  UpstreamDocumentPage: 'knowledge.md',
  UpstreamDocumentPlacement: 'knowledge.md',
  UpstreamDocumentRequest: 'knowledge.md',
  UpstreamDocumentsRequest: 'knowledge.md',
  UpstreamKnowledgeBase: 'knowledge.md',
  UpstreamPassage: 'knowledge.md',
  UpstreamSearchRequest: 'knowledge.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PresetWorkspace: 'preset workspace requirement vocabulary is owned by packages/preset/agent-presets/README.md',
