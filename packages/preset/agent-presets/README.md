...
|---|---|---|
| `default` | required | Deployment fallback preset id for a session with a working directory that names none, used while mode selection is disabled or no user default overrides it; it must declare `workspace: required` |
