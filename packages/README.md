...
| [`guard/`](guard/README.md) | Tool-call guards: advisory repeat-call reminders, the `tools/execute` deadline enforcer, and the per-composition tool-catalog restriction |
