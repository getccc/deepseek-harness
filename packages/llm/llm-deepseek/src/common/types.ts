...
/**
 * Provider route reserved for models supplied by a deployment transport. It
 * always speaks Chat Completions, whatever {@link DeepSeekConnectionOptions.protocol}
 * selects for the member route, because the transport carries the
