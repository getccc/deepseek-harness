...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'team-local-login AssistantIdentity',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Entries at the top of the composer card, above the draft\'s own attachments, naming what the next message is answered from — a knowledge document a conversation was opened about, for one.',
    doc: 'Entries at the top of the composer card, above the draft\'s own\nattachments, naming what the next message is answered from — a\nknowledge document a conversation was opened about, for one. A list,\nbecause the draft attachment rail is the single slot one plugin owns.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-knowledge KnowledgeDocumentCards id \'knowledge-documents\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-web-access WebAccessChip',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Voice-input control between the composer\'s context meter and its submit action.',
    doc: 'Voice-input control between the composer\'s context meter and its submit action.',
    registerOptions: [],
    ownerProps: [
      '/** Owner share of the named plan, permission, and model controls. */\nexport interface InputControlOwnerProps {\n  /** Whether the composer currently refuses interaction. */\n  locked: boolean\n}',
    ],
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-voice VoiceInputButton',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-knowledge-panels KnowledgeBasesPanel',
      'client-ui-knowledge-panels KnowledgeSearchPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional replacement for the ordinary Settings trigger.',
    doc: 'Optional replacement for the ordinary Settings trigger. Team surfaces\nuse it for an account launcher whose menu can still open Settings.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'team-local-login TeamAccountLauncher',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.launcher\', () => ctx.slots.register(\n      { name: \'settings.launcher\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings-general/src/client/shell-contract.ts:25',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-knowledge-panels KnowledgeBasesGlyph',
      'client-ui-knowledge-panels KnowledgeSearchGlyph',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The Recent list below the Workspace tree, inside the same shell-owned scrolling region column.',
    doc: 'The Recent list below the Workspace tree, inside the same shell-owned\nscrolling region column. Declared by this package\'s \'sidebar\' entry;\nui-workspace registers the list. Same owner share as the tree.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace RecentBrowser',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-sidebar-documentpreview-office body',
