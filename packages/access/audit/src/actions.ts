...
export const AUDIT_ACTIONS = {
  ...
  'member.update': { resourceType: 'member', metadata: [] },
  ...
  'role.update': { resourceType: 'role', metadata: [] },
  'role.delete': { resourceType: 'role', metadata: [] },
  'menu.create': { resourceType: 'menu', metadata: [] },
  'menu.update': { resourceType: 'menu', metadata: [] },
  'menu.delete': { resourceType: 'menu', metadata: [] },
  ...
  'knowledge.document.list': { resourceType: 'knowledge_scope', metadata: ['itemCount', 'knowledgeFailure'] },
  'knowledge.document.read': { resourceType: 'knowledge_scope', metadata: ['knowledgeFailure'] },
  'knowledge.catalog.sync': { resourceType: 'knowledge_scope', metadata: ['itemCount', 'knowledgeFailure'] },
  'bi.charts': { resourceType: 'bi_project', metadata: ['itemCount', 'biFailure'] },
  'bi.query': { resourceType: 'bi_project', metadata: ['itemCount', 'biFailure'] },
  'bi.catalog.sync': { resourceType: 'bi_project', metadata: ['itemCount', 'biFailure'] },
