...
export const name = 'team-bundle-invariant'
...
// emits no events, and owns no mutable relation to check. The webserver row
// it overrides carries its own bind invariants in `dsh-host-webserver`.
