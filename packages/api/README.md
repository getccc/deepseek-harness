...
| [`workspace-controller/`](workspace-controller/README.md) | Owns Workspace mutations, the complete Client Workspace projection, and the browser's one file-open door to the Host opener. | `ctx.workspaceController` / `ctx.remote.workspace` |
