...
| [`workspace-controller/`](workspace-controller/README.zh.md) | 拥有 Workspace 变更、完整 Client Workspace 投影，以及浏览器通往 Host 打开器的唯一文件打开入口。 | `ctx.workspaceController` / `ctx.remote.workspace` |
