...
export const zh = {
  ...
  'message.compaction.running': '小微正在压缩上下文…',
  ...
  'message.turnProcess.summary': '小微{labels}',
  'message.turnProcess.toolCalls.one': '调用了 {count} 次工具',
  'message.turnProcess.toolCalls.other': '调用了 {count} 次工具',
  'message.turnProcess.messages.one': '回复了 {count} 条消息',
  'message.turnProcess.messages.other': '回复了 {count} 条消息',
  'message.turnProcess.subagents.one': '派出了 {count} 个 subagent',
  'message.turnProcess.subagents.other': '派出了 {count} 个 subagent',
  'message.turnProcess.thoughtForAWhile': '小微思考了一会儿',
  'message.turnProcess.separator': ' · ',
  'message.stopped': '小微停下了',
  'message.branch': '在新对话中分支',
  'message.branchUnavailable': '仅可从已完成轮次的最后一条消息分支',
  'message.retry.active': '小微正在重试模型请求',
  'message.retry.cancelled': '小微取消了重试',
  'message.retry.started': '小微重试了模型请求',
  'message.retry.scheduled': '小微稍后重试模型请求',
  ...
  'command.running': '小微正在执行…',
  'command.failed': '指令失败',
  'command.done': '已完成',
  'command.title': '指令',
  'row.running': '小微正在执行',
  'reasoning.running': '小微正在思考',
  'row.failed': '失败',
...
export const en = {
  ...
  'details.running': 'Xiaowei is still running this tool…',
  ...
  'message.compaction.running': 'Xiaowei is compacting the context…',
  ...
  'message.turnProcess.summary': 'Xiaowei {labels}',
  'message.turnProcess.toolCalls.one': 'made {count} tool call',
  'message.turnProcess.toolCalls.other': 'made {count} tool calls',
  'message.turnProcess.messages.one': 'sent {count} message',
  'message.turnProcess.messages.other': 'sent {count} messages',
  'message.turnProcess.subagents.one': 'ran {count} subagent',
  'message.turnProcess.subagents.other': 'ran {count} subagents',
  'message.turnProcess.thoughtForAWhile': 'Xiaowei thought for a while',
  'message.turnProcess.separator': ' · ',
  'message.stopped': 'Xiaowei stopped',
  ...
  'message.retry.active': 'Xiaowei is retrying the model request',
  'message.retry.cancelled': 'Xiaowei cancelled the retry',
  'message.retry.started': 'Xiaowei retried the model request',
  'message.retry.scheduled': 'Xiaowei will retry the model request',
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
  ...
  'command.running': 'Xiaowei is running it…',
  'command.failed': 'Command failed',
  'command.done': 'Completed',
  'command.title': 'Command',
  'row.running': 'Xiaowei is running it',
  'reasoning.running': 'Xiaowei is thinking',
  'row.failed': 'Failed',
