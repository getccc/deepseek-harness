...
export const zh = {
  ...
  'drawer.copy': '复制内容',
  'drawer.copied': '已复制',
  'drawer.download': '下载原文件',
  'preview.loading': '正在读取文档内容',
  'preview.failed': '文档内容读取失败',
  'preview.truncated': '文档较长，这里只显示解析出的前一部分文本',
  'preview.unsupported': '这里还不能显示这种文件，可以下载后查看',
  'search.title': '知识检索',
  'search.hero': '在知识库中找到原文，围绕原文对话',
  'search.scope.aria': '检索范围：{scope}',
  'search.scope.all': '全部知识库',
  'search.placeholder': '你想知道什么？',
  'search.run': '检索',
  'search.feed.loading': '正在读取文档',
  'search.feed.failed': '文档读取失败',
  'search.feed.empty': '检索范围内还没有文档',
  'search.rank': '排名 {rank}',
  'search.running': '正在检索',
  'search.empty': '没有检索到相关内容',
  'search.failed': '检索失败',
  'search.summary': '相关度最高的 {documents} 篇原文',
  'search.score': '相似度 {score}',
  'search.passage.truncated': '（本段已截断）',
  'search.discuss': '打开对话，基于这篇原文回答',
...
export const en = {
  ...
  'drawer.close': 'Close',
  'drawer.copy': 'Copy content',
  'drawer.copied': 'Copied',
  'drawer.download': 'Download the file',
  'preview.loading': 'Reading the document',
  'preview.failed': 'The document could not be read',
  'preview.truncated': 'The document is long; only the beginning of its parsed text is shown',
  'preview.unsupported': 'This kind of file cannot be shown here yet; download it to read it',
  'search.title': 'Knowledge search',
  'search.hero': 'Find the source in your knowledge bases, then talk it through',
  'search.scope.aria': 'Search in: {scope}',
  'search.scope.all': 'All knowledge bases',
  'search.placeholder': 'What do you want to know?',
  'search.run': 'Search',
  'search.feed.loading': 'Reading documents',
  'search.feed.failed': 'The documents could not be read',
  'search.feed.empty': 'No documents in this scope yet',
  'search.rank': 'Rank {rank}',
  'search.running': 'Searching',
  'search.empty': 'Nothing matched',
  'search.failed': 'Search failed',
  'search.summary': 'The {documents} most relevant documents',
  'search.score': 'Score {score}',
  'search.passage.truncated': '(passage cut)',
  'search.discuss': 'Open a conversation answered from this document',
