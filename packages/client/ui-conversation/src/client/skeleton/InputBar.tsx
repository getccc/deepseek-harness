...
export const InputBar = memo(function InputBar({
  ...
  // Owner-declared: a chat session runs a tool-less preset, so the permission
  // and plan seats have nothing to govern and stay out of the row.
      ...
      >
        ...
        <div className={css.row}>
          <div className={css.tools}>
            ...
            />
            {/* The mode chips (permission, plan) belong to workspace sessions; a
